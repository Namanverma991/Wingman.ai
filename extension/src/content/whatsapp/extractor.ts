/**
 * WhatsApp content script — main entry point.
 *
 * Orchestrates:
...
function extractAndSendConversation(): void {
  ...
  const container = document.querySelector(WA_SELECTORS.CONVERSATION_PANEL)
    || document.querySelector(WA_SELECTORS.CONVERSATION_PANEL_FALLBACK);
...
function initialize(): void {
  console.log('[Wingman AI] WhatsApp content script loaded');
  ...
  console.log('[Wingman AI] WhatsApp integration initialized');
}
